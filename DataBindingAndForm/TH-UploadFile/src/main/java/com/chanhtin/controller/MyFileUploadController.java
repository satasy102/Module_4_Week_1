...
import com.chanhtin.form.MyUploadForm;
...
public class MyFileUploadController {
    ...
    private String doUpload(HttpServletRequest request, Model model, MyUploadForm myUploadForm) {
        ...
        String uploadRootPath = "D:\\HocLapTrinh\\Module_4\\Week_1\\DataBindingAndForm\\TH-UploadFile\\src\\main\\webapp\\WEB-INF\\Upload";
        ...
        for (CommonsMultipartFile fileData : fileDatas) {
            ...
            if (filename != null && filename.length() > 0) {
                try {
                    // Tạo file tại Server.
                    File serverFile = new File(uploadRootDir + File.separator + filename);
        ...
        model.addAttribute("uploadedFiles", uploadedFiles.values());
        return "uploadResult";
    }
}
